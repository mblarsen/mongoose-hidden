        ...
        schema.eachPath(function (pathname, schemaType) {
          ...
          if (
            ...
            if (typeof finalTransform[_pathname] === 'undefined') {
              ...
              //check for custom path transform
              var pathTransform;
              if(schemaType.options && 
                schemaType.options.transform && 
                _.isFunction(schemaType.options.transform)){
                pathTransform = schemaType.options.transform;
              }

              if(schemaType.caster && 
                schemaType.caster.options && 
                _.isFunction(schemaType.caster.options.transform)){
                pathTransform = schemaType.caster.options.transform;
              }

              finalTransform[_pathname] = 
                _.isFunction(pathTransform) ? pathTransform(ret[_pathname], schemaType) : ret[_pathname];
